function draw() {
    ...
    if (canvas.getContext) {
      ...
      var fruit = [
          {name:"Jan", quantity:20, color:"red"},
          {name:"Feb", quantity:10, color:"orange"},
          {name:"March", quantity:15, color:"yellow"},
          {name:"April", quantity:3, color:"green"},
          {name:"May", quantity:5, color:"blue"},
          {name:"June", quantity:8, color:"purple"}
      ];
      var x = 50, y=0, i=0;
      drawName(ctx);
      flipY(ctx);
