...
new Chart(document.getElementById("bar-chart"), {
    ...
    options: {
      ...
      title: {
        display: true,
        text: 'These are the Top 10 SAT reading Mean Score In 2010'
      }
    }
});
}
...
function createChart2(){
    ...
    type: 'horizontalBar',
    data: {
      labels: ["SHS", "SITHS", "THHS at QUEENS COLLEGE", "HS of American Studies at Lehman College", "BHSoS", "BHSEC", "QHS FOR SCIENCE YORK COL", "HSfMath at SECC", "BTHS", "BC"],
      datasets: [
        {
